#!/usr/bin/env python3
"""
BanglaGamba — Final Corpus Builder (Plan A)
=============================================
...
Output: saved/data/final/banglagamba_corpus.jsonl
Usage:
...
def pipeline(args):
    ...
    print(f"{'='*60}")
    print(f"  BanglaGamba Corpus Builder (Plan A)")
    print(f"{'='*60}")
...
def main():
    ...
    parser.add_argument("--output", default="banglagamba_corpus.jsonl")
